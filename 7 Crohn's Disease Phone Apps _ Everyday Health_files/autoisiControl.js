...
function foo(){}
var sizes = {
	dim160x600:{t:330,l:0,  w:160,h:270,  hh:30,isiPauseTime:6,isiScrollTime:560},
	dim300x250:{t:125,l:0,  w:300,h:125,  hh:20,isiPauseTime:6,isiScrollTime:560},
	dim300x600:{t:350,l:0,  w:300,h:250,  hh:20,isiPauseTime:6,isiScrollTime:560},
	dim728x90: {t:0,  l:337,w:391,h:90,   hh:20,isiPauseTime:6,isiScrollTime:560}
	}
var bannerType;
...
function initISI(epass, headerPosition){
	...
	if(id=="dim160x600"){
		...
		headerLinksText = "<div style='opacity:1 !important'>"+getFPILink()+"</div><div style='opacity:1 !important; right:10px;'>"+getMGLink()+"</div>";
	}
